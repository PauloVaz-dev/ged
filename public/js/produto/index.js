...
var table = $('#produto').DataTable({
    ...
    columns: [
        ...
        {data: 'preco_revenda', name: 'preco_revenda', "render": function (data) { return formatMoney(data) }},
        {data: 'preco_franquia', name: 'preco_franquia', "render": function (data) { return formatMoney(data) }},
